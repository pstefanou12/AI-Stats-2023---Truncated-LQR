'''
Parent class for models to train in model trainer.
'''
...
COSINE = 'cosine'
LINEAR = 'linear'
# default parameters for Model module (can be overridden by any class
DEFAULTS = {
        'epochs': (int, 1),
        'num_trials': (int, 3),
        'val': (float, .2),
    ...
    def __init__(self, args): 
        ...
        Args: 
            args (delphi.utils.helpers.Parameters) : parameter object holding hyperparameters
                ...
                attributes. See :attr:`defaults.TRAINING_ARGS` for a 
                list of arguments, and you can use
                :meth:`defaults.check_and_fill_args` to make sure that
